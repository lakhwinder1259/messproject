...
<input type="submit" class="buttons" name="mess bill" value="mess bill">
<input type="submit" class="buttons" name="post complaint" value="post complaint">
<input type="submit" class="buttons" name="notices" value="notices">
